  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {user.role === 'arbitro' && (
          <div className="card mb-6 bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200">
              ...
              {user.calificacionPromedio > 0 ? (
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="text-2xl font-bold text-gray-800">
                        {user.calificacionPromedio.toFixed(2)} / 5.00
                      </div>
                    </div>
                  </div>
                  <div className="text-center px-6 py-3 bg-white rounded-lg shadow-sm">
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-sm text-gray-600 max-w-md mx-auto">
                    Aún no has recibido calificaciones de los organizadores. Una vez que completes tus primeros partidos, 
                    aquí podrás ver tu reputación como árbitro.
                  </p>
