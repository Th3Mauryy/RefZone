...
<p>Saludos,<br>Equipo RefZone</p>`
                        ...
                        const historialPartido = new HistorialPartido({
                            ...
                            estado: 'Finalizado',
                            canchaId: partido.canchaId || null, // Puede ser null para partidos antiguos
...
app.use('/api/auth', authRoutes); // AGREGAR: Alias para compatibilidad
app.use('/api/games', gameRoutes);    // Rutas de partidos
app.use('/api/canchas', require('./routes/canchaRoutes')); // Rutas de canchas
app.use('/api/ubicaciones', require('./routes/ubicacionRoutes')); // Rutas de ubicaciones
...
app.use('/ubicaciones', require('./routes/ubicacionRoutes'));
...
// Middleware para manejar CSRF (DESHABILITADO temporalmente para desarrollo)
// En producción, considera implementar CSRF correctamente con tokens en cada request
